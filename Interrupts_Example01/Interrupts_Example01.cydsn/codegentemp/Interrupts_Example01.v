// ======================================================================
// Interrupts_Example01.v generated from TopDesign.cysch
// 09/24/2017 at 22:19
...
module top ;
	...
	wire [0:0] tmpOE__LED_Isr_net;
	wire [0:0] tmpFB_0__LED_Isr_net;
	wire [0:0] tmpIO_0__LED_Isr_net;
	wire [0:0] tmpINTERRUPT_0__LED_Isr_net;
	electrical [0:0] tmpSIOVREF__LED_Isr_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("84e5201e-80b3-4a31-b1f7-61a4636b0c6c"),
		  ...
		  .input_buffer_sel(2'b00))
		LED_Isr
		 (.oe(tmpOE__LED_Isr_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED_Isr_net[0:0]}),
		  .io({tmpIO_0__LED_Isr_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_Isr_net),
		  .interrupt({tmpINTERRUPT_0__LED_Isr_net[0:0]}),
		  .annotation({Net_47}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__LED_Isr_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LED_Nested_net;
	wire [0:0] tmpFB_0__LED_Nested_net;
	wire [0:0] tmpIO_0__LED_Nested_net;
	wire [0:0] tmpINTERRUPT_0__LED_Nested_net;
	electrical [0:0] tmpSIOVREF__LED_Nested_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("bd9c6da6-f194-44a8-bc2e-1361f5eda610"),
		  ...
		  .input_buffer_sel(2'b00))
		LED_Nested
		 (.oe(tmpOE__LED_Nested_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED_Nested_net[0:0]}),
		  .io({tmpIO_0__LED_Nested_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_Nested_net),
		  .interrupt({tmpINTERRUPT_0__LED_Nested_net[0:0]}),
		  .annotation({Net_1782}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__LED_Nested_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__Pin_SW_1_net;
	wire [0:0] tmpFB_0__Pin_SW_1_net;
	wire [0:0] tmpIO_0__Pin_SW_1_net;
	electrical [0:0] tmpSIOVREF__Pin_SW_1_net;

	cy_psoc3_pins_v1_10
		#(.id("1cb2fd9e-e16e-485d-88e7-8544ef6db868"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_SW_1
		 (.oe(tmpOE__Pin_SW_1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_SW_1_net[0:0]}),
		  .io({tmpIO_0__Pin_SW_1_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_SW_1_net),
		  .interrupt({Net_23}),
		  .annotation({Net_26}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
	...
	assign tmpOE__Pin_SW_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
