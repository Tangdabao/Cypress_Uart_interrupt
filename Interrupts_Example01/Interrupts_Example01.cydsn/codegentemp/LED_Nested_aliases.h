...
#define LED_Nested_0_PS		(LED_Nested__0__PS)
#define LED_Nested_0_PC		(LED_Nested__0__PC)
#define LED_Nested_0_DR		(LED_Nested__0__DR)
#define LED_Nested_0_SHIFT	(LED_Nested__0__SHIFT)
#define LED_Nested_0_INTR	((uint16)((uint16)0x0003u << (LED_Nested__0__SHIFT*2u)))
